function [Utilities,tin,queue,avgArrivalTimes,cumUsers]=BottleneckDynamicsAndUtilityEvaluationWithAccessTime(departureTimes,R,S,population,Tf)
...
for i=1:population.N
    ...
    avgUD=(population.intUD{i}(Tf+tex(2:end))-population.intUD{i}(Tf+tex(1:end-1)))./(tex(2:end)-tex(1:end-1));
